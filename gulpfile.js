...
var dir  = {
    ...
    dist_react      : pRoot + "inc/"     + 'js/react/',        // 생성 스크립트
    ...
    dev_jsx         : pRoot + "dev_inc/"  + 'js/jsx/',          // 개발 jsx
...
// ---------------------------------
// Tasks react    // *.jsx -> 합치기   react_common.js
// ---------------------------------
gulp.task("jsx", function(){
    return gulp.src([ dir.dev_jsx + "*.jsx" ])
    .pipe(babel())
	//.pipe(concat('react_common.js', {newLine: ';'}))
    .pipe(gulp.dest( dir.dist_react + '' ))
});

// ---------------------------------
// Tasks concatJs    // *.js -> 합치기   common.js
// ---------------------------------
gulp.task('concatJs', ['jsx'], function(){
...
gulp.task('watch', function(){
    ...
    gulp.watch([dir.dev_jsx + '*.jsx', dir.dev_scripts + '*.js' ],        ['jsmin']);
